...
values (uuid_generate_v1(), 'e0087092-22b2-11ed-a2fe-b7147dec817d', 7, 5, 'Jasne', 3.0, 2.5, 4.3),
       ...
       (uuid_generate_v1(), 'd4ce25e2-22ac-11ed-b5a4-77ac144b4ca4', 14, 2, 'empty', 8.8, 1.0, 4.3),
       (uuid_generate_v1(), 'd4ce25e2-22ac-11ed-b5a4-77ac144b4ca4', 12, 3, 'empty', 12.3, 7.0, 4.3),
       (uuid_generate_v1(), 'd4ce25e2-22ac-11ed-b5a4-77ac144b4ca4', 16, 2, 'empty', 14.0, 0.8, 7.0),
       (uuid_generate_v1(), 'd4cbb51e-22ac-11ed-b5a2-fb8148c2bec2', 4, 3, 'empty', 5.9, 8.7, 0.0),
       (uuid_generate_v1(), 'd4cbb51e-22ac-11ed-b5a2-fb8148c2bec2', 5, 1, 'empty', 4.0, 12.0, 31.2),
       (uuid_generate_v1(), 'd4cbb51e-22ac-11ed-b5a2-fb8148c2bec2', 8, 4, 'empty', 0.9, 0.0, 11.0),
       (uuid_generate_v1(), 'd4cbb51e-22ac-11ed-b5a2-fb8148c2bec2', 36, 5, 'empty', 1.1, 2.0, 7.0),
       (uuid_generate_v1(), 'e008978e-22b2-11ed-a2ff-cbfae0543424', 36, 5, 'empty', 2.8, 2.9, 4.0),
       (uuid_generate_v1(), '070816e8-0e76-432d-995f-700534b28f24', 31, 2, 'empty', 7.0, 3.0, 24.0),
       (uuid_generate_v1(), 'e008978e-22b2-11ed-a2ff-cbfae0543424', 44, 4, 'empty', 0.8, 8.0, 0.5),
       (uuid_generate_v1(), '070816e8-0e76-432d-995f-700534b28f24', 17, 5, 'empty', 7.0, 14.0, 4.0);
